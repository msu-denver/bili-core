...
(``bili/aegis/tests/injection/payloads/prompt_injection_payloads.py``).  No
...
Full run (requires AWS Bedrock + Google Vertex credentials):
    ...
    python bili/aegis/tests/cross_model/run_cross_model_suite.py
...
from bili.aegis.tests._helpers import CONFIG_PATHS
...
from bili.aegis.tests._helpers import model_id_safe as _model_id_safe
from bili.aegis.tests.injection.payloads.prompt_injection_payloads import (  # noqa: E402  pylint: disable=wrong-import-position
    INJECTION_PAYLOADS,
)
