...
Stub mode (no LLM calls — structural verification only):
    ...
    python bili/aegis/tests/persistence/run_persistence_suite.py --stub
...
Results are written to:
    bili/aegis/tests/persistence/results/{mas_id}/{payload_id}_checkpoint_injection.json
    bili/aegis/tests/persistence/results/persistence_results_matrix.csv
"""
