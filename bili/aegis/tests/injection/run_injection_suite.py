...
Runs all 15 prompt injection payloads against the 5 content-moderation MAS
...
Results are written to:
    bili/aegis/tests/injection/results/{mas_id}/{payload_id}_{phase}.json
    bili/aegis/tests/injection/results/injection_results_matrix.csv
