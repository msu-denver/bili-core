...
Default log path: ``bili/aegis/security/logs/security_events.ndjson``
...
from bili.aegis.security.models import SecurityEvent
...
class SecurityEventLogger:
    ...
    Args:
        log_path: Path to the NDJSON log file.  Parent directories are
            ...
            ``bili/aegis/security/logs/security_events.ndjson``.
    """
