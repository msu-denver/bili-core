...
Dependencies:
    ...
    - bili.iris.loaders.embeddings_loader: Imports `load_embedding_function` for
      loading embedding functions.
    - bili.iris.tools.amazon_opensearch: Imports `init_amazon_opensearch` for
      initializing Amazon OpenSearch tools.
    - bili.iris.tools.api_open_weather: Imports `init_weather_api_tool` for
      initializing weather API tools.
    - bili.iris.tools.api_serp: Imports `init_serp_api_tool` for initializing SERP
      API tools.
    - bili.iris.tools.api_weather_gov: Imports `init_weather_gov_api_tool` for
      initializing Weather.gov API tools.
    - bili.iris.config.tool_config: Imports `TOOLS` for tool configurations.
    - bili.iris.tools.faiss_memory_indexing: Imports `init_faiss` for initializing
      FAISS retrievers.
    - bili.iris.tools.mock_tool: Imports `init_mock_tool` for initializing mock
      tools.
