...
Example:
--------
from bili.iris.nodes.add_persona_and_summary import build_add_persona_and_summary_node
...
persona_and_summary_node = partial(
    Node, "add_persona_and_summary", build_add_persona_and_summary_node
)
