...
Example:
--------
from bili.iris.nodes.inject_current_date_time import build_inject_current_date_time
...
inject_current_datetime_node = partial(
    Node, "inject_current_datetime", build_inject_current_date_time
)
