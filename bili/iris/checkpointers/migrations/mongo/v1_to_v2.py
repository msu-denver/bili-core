...
from bili.iris.checkpointers.versioning import register_migration
...
def migrate_checkpoint_collection(
    ...
    Example:
        ...
        from bili.iris.checkpointers.migrations.mongo.v1_to_v2 import migrate_checkpoint_collection
...
def migrate_all_collections(db, dry_run: bool = True) -> Dict[str, Dict[str, int]]:
    ...
    Example:
        from pymongo import MongoClient
        from bili.iris.checkpointers.migrations.mongo.v1_to_v2 import migrate_all_collections
