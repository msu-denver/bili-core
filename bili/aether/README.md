...
| [docs/testing-baseline.md](docs/testing-baseline.md)             | Baseline test suite — reproducibility requirements, stub and real-LLM modes, result file format               |
| [docs/testing-injection.md](docs/testing-injection.md)           | Prompt injection test suite — 10 payloads × 5 configs × 2 phases, three-tier detection, results matrix        |
| [docs/testing-jailbreak.md](docs/testing-jailbreak.md)           | Jailbreak test suite — payload taxonomy, role-abandonment scoring rubric, cross-suite CSV joins                |
...
**AETHER Version:** 1.0.0 | **bili-core Required:** ≥3.0.0
