...
def _render_intro() -> None:
    ...
    st.markdown(
        ...
        "every agent inherits access to 107 LLM model configurations across "
        "18 provider types (API providers: AWS Bedrock, Google Vertex AI, "
        "Azure OpenAI, OpenAI, Anthropic, Mistral AI, Cohere, Google "
        "Generative AI, DeepSeek, xAI, Groq; CLI presets: Claude Code, "
        "Codex, Gemini CLI; generic CLI subprocess; local: llama.cpp, "
        "HuggingFace, Ollama), "
